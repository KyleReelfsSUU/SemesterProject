...
public class pianoGUI {
	 ...
	 */
		JCheckBox acousticGuitar;
		acousticGuitar = new JCheckBox("Acoustic Guitar");
		acousticGuitar.setSelected(false);
		acousticGuitar.setBounds(850,425,150,50);
		frame.getContentPane().add(acousticGuitar);
		...
		button_17.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(acousticGuitar.isSelected())
				{
					b.playAcousticGuitar();
				}else if(!acousticGuitar.isSelected())
				{
				...
				ImageIcon icon = new ImageIcon("low B.jpg");
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
				JFrame note = new JFrame();
				ImageIcon icon = new ImageIcon("low C.jpg");
				JLabel noteName = new JLabel(icon);
				note.add(noteName);
				note.pack();
				note.setVisible(true);
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
				JFrame note = new JFrame();
				ImageIcon icon = new ImageIcon("low D.jpg");
				JLabel noteName = new JLabel(icon);
				note.add(noteName);
				note.pack();
				note.setVisible(true);
		...
		button_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
				JFrame note = new JFrame();
				ImageIcon icon = new ImageIcon("low E.jpg");
				JLabel noteName = new JLabel(icon);
				note.add(noteName);
				note.pack();
				note.setVisible(true);
		...
		button_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
				JFrame note = new JFrame();
				ImageIcon icon = new ImageIcon("low F.jpg");
				JLabel noteName = new JLabel(icon);
				note.add(noteName);
				note.pack();
				note.setVisible(true);
		...
		button_4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
				JFrame note = new JFrame();
				ImageIcon icon = new ImageIcon("low G.jpg");
				JLabel noteName = new JLabel(icon);
				note.add(noteName);
				note.pack();
				note.setVisible(true);
		...
		button_5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
				JFrame note = new JFrame();
				ImageIcon icon = new ImageIcon("Middle A.jpg");
				JLabel noteName = new JLabel(icon);
				note.add(noteName);
				note.pack();
				note.setVisible(true);
		...
		button_6.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
				JFrame note = new JFrame();
				ImageIcon icon = new ImageIcon("Middle B.jpg");
				JLabel noteName = new JLabel(icon);
				note.add(noteName);
				note.pack();
				note.setVisible(true);
		...
		button_7.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
				JFrame note = new JFrame();
				ImageIcon icon = new ImageIcon("Middle C.jpg");
				JLabel noteName = new JLabel(icon);
				note.add(noteName);
				note.pack();
				note.setVisible(true);
		...
		button_8.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
				JFrame note = new JFrame();
				ImageIcon icon = new ImageIcon("Middle D.jpg");
				JLabel noteName = new JLabel(icon);
				note.add(noteName);
				note.pack();
				note.setVisible(true);
		...
		button_9.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
				JFrame note = new JFrame();
				ImageIcon icon = new ImageIcon("Middle E.jpg");
				JLabel noteName = new JLabel(icon);
				note.add(noteName);
				note.pack();
				note.setVisible(true);
		...
		button_10.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
				JFrame note = new JFrame();
				ImageIcon icon = new ImageIcon("Middle F.jpg");
				JLabel noteName = new JLabel(icon);
				note.add(noteName);
				note.pack();
				note.setVisible(true);
		...
		button_11.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
				JFrame note = new JFrame();
				ImageIcon icon = new ImageIcon("Middle G.jpg");
				JLabel noteName = new JLabel(icon);
				note.add(noteName);
				note.pack();
				note.setVisible(true);
		...
		button_12.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
				JFrame note = new JFrame();
				ImageIcon icon = new ImageIcon("High A.jpg");
				JLabel noteName = new JLabel(icon);
				note.add(noteName);
				note.pack();
				note.setVisible(true);
		...
		button_13.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
				JFrame note = new JFrame();
				ImageIcon icon = new ImageIcon("High B.jpg");
				JLabel noteName = new JLabel(icon);
				note.add(noteName);
				note.pack();
				note.setVisible(true);
		...
		button_14.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
				JFrame note = new JFrame();
				ImageIcon icon = new ImageIcon("High C.jpg");
				JLabel noteName = new JLabel(icon);
				note.add(noteName);
				note.pack();
				note.setVisible(true);
		...
		btnSharp.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
				JFrame note = new JFrame();
				ImageIcon icon = new ImageIcon("Low C Sharp.jpg");
				JLabel noteName = new JLabel(icon);
				note.add(noteName);
				note.pack();
				note.setVisible(true);
		...
		button_18.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
				JFrame note = new JFrame();
				ImageIcon icon = new ImageIcon("Low A Sharp.jpg");
				JLabel noteName = new JLabel(icon);
				note.add(noteName);
				note.pack();
				note.setVisible(true);
		...
		btnSharp_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
				JFrame note = new JFrame();
				ImageIcon icon = new ImageIcon("Low D Sharp.jpg");
				JLabel noteName = new JLabel(icon);
				note.add(noteName);
				note.pack();
				note.setVisible(true);
		...
		btnSharp_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
				JFrame note = new JFrame();
				ImageIcon icon = new ImageIcon("Low F Sharp.jpg");
				JLabel noteName = new JLabel(icon);
				note.add(noteName);
				note.pack();
				note.setVisible(true);
		...
		btnSharp_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
				JFrame note = new JFrame();
				ImageIcon icon = new ImageIcon("Low G Sharp.jpg");
				JLabel noteName = new JLabel(icon);
				note.add(noteName);
				note.pack();
				note.setVisible(true);
		...
		btnSharp_4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
				JFrame note = new JFrame();
				ImageIcon icon = new ImageIcon("Middle A Sharp.jpg");
				JLabel noteName = new JLabel(icon);
				note.add(noteName);
				note.pack();
				note.setVisible(true);
		...
		btnSharp_5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
				JFrame note = new JFrame();
				ImageIcon icon = new ImageIcon("Middle C Sharp.jpg");
				JLabel noteName = new JLabel(icon);
				note.add(noteName);
				note.pack();
				note.setVisible(true);
		...
		btnSharp_6.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
				JFrame note = new JFrame();
				ImageIcon icon = new ImageIcon("Middle D Sharp.jpg");
				JLabel noteName = new JLabel(icon);
				note.add(noteName);
				note.pack();
				note.setVisible(true);
		...
		btnSharp_7.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
				JFrame note = new JFrame();
				ImageIcon icon = new ImageIcon("Middle F Sharp.jpg");
				JLabel noteName = new JLabel(icon);
				note.add(noteName);
				note.pack();
				note.setVisible(true);
		...
		btnSharp_8.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
				JFrame note = new JFrame();
				ImageIcon icon = new ImageIcon("Middle G Sharp.jpg");
				JLabel noteName = new JLabel(icon);
				note.add(noteName);
				note.pack();
				note.setVisible(true);
		...
		button_15.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
				JFrame note = new JFrame();
				ImageIcon icon = new ImageIcon("High A Sharp.jpg");
				JLabel noteName = new JLabel(icon);
				note.add(noteName);
				note.pack();
				note.setVisible(true);
		...
		button_16.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
				JFrame note = new JFrame();
				ImageIcon icon = new ImageIcon("High C Sharp.jpg");
				JLabel noteName = new JLabel(icon);
				note.add(noteName);
				note.pack();
				note.setVisible(true);
